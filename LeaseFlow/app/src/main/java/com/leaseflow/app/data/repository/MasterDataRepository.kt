...
import com.leaseflow.app.data.remote.dto.EstadoRemoteDTO
import com.leaseflow.app.data.remote.dto.RolRemoteDTO
...
class MasterDataRepository(context: Context) {
    ...
    companion object {
        private const val PREFS_NAME = "leaseflow_master_data"
