...
import com.leaseflow.app.data.local.dao.*
import com.leaseflow.app.data.local.entities.*
...
abstract class LeaseFlowDatabase : RoomDatabase() {
    ...
    companion object {
        private const val TAG = "LeaseFlowDatabase"
         ...
         */
        private suspend fun verificarYPoblarDatos(db: LeaseFlowDatabase) {
            try {
         ...
         */
        private suspend fun poblarDatosIniciales(db: LeaseFlowDatabase) {
            val catalogDao = db.catalogDao()
            ...
            try {
                ...
                Log.d(TAG, "Admin creado: admin@leaseflow.cl / Admin123!")
